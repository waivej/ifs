...
For many years afterward, the developer's father — **Charles Waiveris**, a college mathematics professor — made IFS a recurring classroom assignment across **13 years of mathematics courses** and summer programs like **CAMPY** (for high school students). The assignment had a simple appeal: students would tweak transformation parameters, watch a fractal emerge on screen, and discover that adjusting a few numbers could produce something genuinely beautiful. It turned out to be a rare assignment that was both mathematically rigorous and creatively open-ended — students who didn't think of themselves as artists suddenly had something to show off. His work with IFS in the classroom was published in the National Council of Teachers of Mathematics journal *Mathematics Teacher*: **["Iterated Function Systems in the Classroom"](https://eric.ed.gov/?id=EJ756698)** (Vol. 100, No. 5, pp. 369–374, January 2007). John maintained and extended the software throughout this period specifically to support his father's classroom work, adding features, fixing problems, and eventually porting the whole application to the web so students no longer needed to install anything.

Each semester, the best images were submitted to a panel of professional artists who voted on their favorites. The top-scoring students received **custom screen-printed t-shirts** bearing their own IFS design — a tangible prize that made the mathematical creativity feel real.

The collaborative classroom experience was made possible by a companion website John built alongside the application, where students could create accounts, upload their `.ifs` files and rendered images, and browse what their classmates had created. Seeing your fractal next to everyone else's — and competing in a friendly artistic competition — made the mathematics feel alive.
