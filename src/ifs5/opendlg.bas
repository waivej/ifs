...
Private Function FilterLookup(ByVal sFilters As String, ByVal iCur As Long) As String
    ...
    Loop While iCur
End Function
'// show save dialog function (pass/return filestruct)
Public Function ShowSaveDialog(filestruct As stcFileStruct) As Boolean
    With filestruct
        If .strFilter = Empty Then .strFilter = "All Files|*.*"
        ShowSaveDialog = VBGetSaveFileName(.strFileName, .strFileTitle, True, , .blnReadOnly, , .strFilter, .lngFilterIndex, , .strDialogtitle)
    End With
...
'    File.strFilter = "Text Files *.txt|*.txt" '// use same format asCommonDialog Control
'    '// pass stcFileStruct
'    ShowOpenDialog File
